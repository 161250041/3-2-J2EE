...
<%@ page import="nju.edu.order.Action.Business.CommodityListBean" %>
<%@ page import="nju.edu.order.Model.CommoditiesEntity" %><%--
...
<ul class="cd-gallery">
    <%
        ArrayList<CommoditiesEntity> commodityList = ((CommodityListBean) session.getAttribute("commodityListBean")).getCommodityList();
        for(CommoditiesEntity commodity:commodityList) {
    %>
